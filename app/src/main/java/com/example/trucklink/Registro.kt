...
import com.example.trucklink.MainActivity.Companion.CAMERA_REQUEST
import com.example.trucklink.MainActivity.Companion.GALLERY_REQUEST
import com.example.trucklink.databinding.ActivityRegistroBinding
...
class Registro : AppCompatActivity(){
    ...
    private fun startCamera(){
        tempImageUri = FileProvider.getUriForFile(this, "com.example.trucklink.provider", createImageFile().also {
